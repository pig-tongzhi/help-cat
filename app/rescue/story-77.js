(function () {
  ...
  var chapters = Object.freeze([
    Object.freeze({ title: "初见 77", marker: "2025 年 6 月 2 日", copy: "2025 年 6 月 2 日，我们第一次遇见了 77。一次相遇，让它被认真记住。" }),
    ...
    Object.freeze({ title: "77 长大了", marker: "成长记录", copy: "从幼年到长大，日常的相处让这段陪伴有了连续的记录。" }),
    Object.freeze({ title: "为什么有帮帮小猫", marker: "一起接力", copy: "一次个人相遇，也让我们看到：让信息可查、行动可接力，才能让社区救助走得更远。" }),
    Object.freeze({ title: "从 77 到每一只小猫", marker: "新的开始", copy: "77 的故事是一个开始。帮帮小猫希望让更多被遇见的猫咪，有机会被认真记录、被持续关注。" })
  ]);
