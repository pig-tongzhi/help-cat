...
class RescueH5ContractTests(unittest.TestCase):
    def test_77_public_media_is_sanitized_and_wired(self):
        ...
        self.assertIn(
            '<img src="assets/77/hero-desktop.webp?v=20260816-image-cache-r2" alt="77，一只白底黑斑的猫咪" width="960" height="720"',
            html,
        )
    ...
    def test_77_brand_assets_and_manifest_are_wired(self):
        ...
        for marker in (
            ...
            'rel="icon" href="assets/brand/favicon.svg?v=20260816-image-cache-r2"',
            'rel="apple-touch-icon" href="assets/brand/apple-touch-icon.png?v=20260816-image-cache-r2"',
            'rel="manifest" href="manifest.webmanifest?v=20260816-image-cache-r2"',
    ...
    def test_brand_uses_one_77_master_across_all_surfaces(self):
        ...
        version = "20260816-image-cache-r2"
    ...
    def test_live_version_update_contract(self):
        ...
        styles = (ROOT / "app" / "rescue" / "styles.css").read_text(encoding="utf-8")
        for marker in (
            'data-app-version="20260816-image-cache-r2"',
            'id="version-update"',
            'id="reload-version"',
        ):
            self.assertIn(marker, html)
        ...
        for marker in (
            ...
            'CURRENT_VERSION = "20260816-image-cache-r2"',
    ...
    def test_77_story_has_responsive_accessible_mobile_contract(self):
        ...
        self.assertIn('story-77.js?v=20260816-image-cache-r2', html)
